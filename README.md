...
## Project Overview
This project focuses on analyzing retail sales data to understand overall business performance, profit trends, return impact, and regional contributions. The solution includes data cleaning, transformation, pivot-based analysis, and an interactive management dashboard built in Excel.
